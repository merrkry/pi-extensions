...
import { buildDetails, formatLifetimeTokens, getStatusNote, textResult } from "#src/tools/helpers";
import type { ResolvedSpawnConfig } from "#src/tools/spawn-config";
import type { ParentSessionInfo, Subagent } from "#src/types";
import { type AgentDetails, describeActivity, formatMs, SPINNER } from "#src/ui/display";
