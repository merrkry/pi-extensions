...
- **Model-performance correlation** — the breaking-change miss happened on the _strongest_ model in the pipeline (`claude-opus-4-8`) during the judgment-heaviest stage (planning).
